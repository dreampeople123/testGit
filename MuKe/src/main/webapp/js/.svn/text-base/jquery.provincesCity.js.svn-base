...
$.fn.ProvinceCity = function(num){
	...
	//插入3个空的下拉框
	if(num=="tian"){
		_self.append("省份：<select id='user_sheng'></select>");
		_self.append("&nbsp;&nbsp;市：<select id='user_shi'></select>");
		_self.append("&nbsp;&nbsp;县/区：<select id='user_xianqu'></select>");
		
	}else if(num="xiu"){
		_self.append("省份：<select id='user_sshengs'></select>");
		_self.append("&nbsp;&nbsp;市：<select id='user_sshi'></select>");
		_self.append("&nbsp;&nbsp;县/区：<select id='user_sxianqu'></select>");
	}
