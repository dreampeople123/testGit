...
<div id="main">
    ...
    <div class="course-info-main">
        ...
        <p style="margin-bottom: 40px;">
        	<a href="javascript:jumpFirst()" class="btn-red">开始学习</a>
        </p>
        </div><!--info-bar结束-->
		<div class="content-warp">
        	...
        	<div class="mod-tab-menu">
            	<ul class="course-menu clearfix">
                    ...
                    <li hidden="hidden" ><a id="commentOn" class="" href="javascript:change('commentOn',2)"><span>评论</span></a></li>
                </ul>
            </div><!--mod-tab-menu结束-->
            ...
            -->
            	...
            	<div class="chapter-active" id="1" style="display:block; margin:10px 0 0 30px;">
            		<c:forEach items="${chapterInfo}" var="CourContent" varStatus="i">
            		<!-- <script>
	                    	...
	                    	<li id="con"  style="display:block">
	                            ...
	                            <c:choose>
	                            	<c:when test="${i.index eq 0}">
	                           			<a href="javascript:jumpToShiPin('${CourContent.cNo}','${CourContent.chNo }','${loginUser.uNo }')" class="studyvideo" id="firstA" >>_${CourContent.chName }<i class="study-state"></i></a>
	                            	</c:when>
	                            	<c:otherwise>
	                           			<a href="javascript:jumpToShiPin('${CourContent.cNo}','${CourContent.chNo }','${loginUser.uNo }')" class="studyvideo" >>_${CourContent.chName }<i class="study-state"></i></a>
	                            	</c:otherwise>
	                            </c:choose>
...
<div id="learner">
	<div hidden="hidden" class="cp-header clearfix">
